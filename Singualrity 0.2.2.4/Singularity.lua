...
SMODS.Joker {
    ...
    loc_txt = {
        name = 'Singularity',
        text = {
            "Each {C:attention}High Card{} hand played",
            "multiplies Mult gained by {C:attention}#2#{}",
...
SMODS.Joker {
    ...
    config = { extra = { high_card_count = 0, high_card_limit = 12 } },
    rarity = 3,
    atlas = 'collapseatlas',
    pos = { x = 0, y = 0 },
    cost = 6,
    loc_vars = function(self, info_queue, card)
        info_queue[#info_queue + 1] = G.P_CENTERS.j_LSingle_singular
